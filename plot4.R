...
par(mfcol=c(2,2))
par(mfg=c(1,1))
plot(Q03$DateTime, Q03$Global_active_power, type="l", xlab="", ylab="Global Active Power")
par(mfg=c(2,1))
...
par(mfg=c(1,2))
plot(Q03$DateTime, Q03$Voltage, type="l", xlab="datetime", ylab="Voltage")
par(mfg=c(2,2))
plot(Q03$DateTime, Q03$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
